  ...
  readonly examples = [
    {
      activities: Agent.parseActivities(dedent`
        <observation>
        The user says: tell me a joke 
        </observation>
        <thought>
        The user wants to hear a joke, possibly to lighten the mood or for entertainment. I need to respond with a light-hearted and appropriate joke using the action Say.
        </thought>
        <action kind="Say">
